...
def run_rf(
    ...
    scores = cross_validate(
        model, train_data, train_labels, cv=5, return_train_score=True
    )
    ...
    new_features = daniel.modelling.show_importances(trained_model, features)
